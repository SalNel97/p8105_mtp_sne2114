...
|      Constructing a two-panel plot with the left panel showing the weight distribution for each pet, and the right panel showing the distribution of weights of each dog over time.
