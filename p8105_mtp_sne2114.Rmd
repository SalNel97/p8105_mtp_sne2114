...
|      Used pivot_longer to rearrange weight measurement per pet name. Also helps with not dropping rows with weight data missing from only 1 or 2 pets. The weight column containing both pound and ounce weight measurements was separated into pound and ounce columns.Same was done to standard deviation column as well.
